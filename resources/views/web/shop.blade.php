                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="{{ URL('web/shop') }}">
                                <div class="hero__search__categories">
                                    All Categories
                                    <span class="arrow_carrot-down"></span>
                                </div>
                                <input type="text" value="{{ $search ?? '' }}" name="search" placeholder="What do yo u need?">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <h6><span>{{ count($list) }}</span> Products found</h6>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        ...
                                        <div class="product__item__text">
                                            <h6><a href="{{ URL('web/shop_detail',$row->id) }}">{{ $row->name }}</a></h6>
                                            <h5>$&nbsp;{{ $row->price }}</h5>
                                        </div>
