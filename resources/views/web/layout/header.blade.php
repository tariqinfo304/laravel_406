...
<div class="humberger__menu__wrapper">
    <div class="humberger__menu__logo">
        <a href="{{ URL('web') }}"><img src="{{ Asset('img/logo.png')}}" alt=""></a>
    </div>
    <div class="humberger__menu__cart">
        <ul>
            <li><a href="{{ URL('web/fav_list') }}"><i class="fa fa-heart"></i> <span>1</span></a></li>
        ...
        <ul>
            ...
            <li><a href="#">Pages</a>
                <ul class="header__menu__dropdown">
                    <li><a href="{{ URL('web/shop_detail') }}">Shop Details</a></li>
